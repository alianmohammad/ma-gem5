...
# Launching dist-gem5 to run a workload using HTCondor 
...
[ -z "$SCRIPT" ] && SCRIPT="../rcS/iperf.rcS"

CKPTDIR=$ROOT_PATH/ckptdir/default

RUNDIR=$ROOT_PATH/rundir/$CONFIG
